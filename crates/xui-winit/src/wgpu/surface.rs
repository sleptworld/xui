use xui_core::render::{BuiltFrame, BuiltLayerInstanceId, CompositePrefixId, SurfacePrefix};
...
mod tests {
    ...
    use std::sync::Arc;
    use xui_core::render::{
        frame_builder::FrameBuilder, FrameProperties, LayerDescriptor, Primitive, RenderScene,
        SceneCompiler, Shape, ShapePrimitive,
    };
    use xui_interface::{
        Affine, Color, ComputedBackdropMask, ComputedBackdropStyle, ComputedColorStyle, Rect,
    };

    fn append_shape(scene: &mut RenderScene, parent: xui_core::render::RenderNodeId, rect: Rect) {
    ...
    fn append_layer(
        ...
        parent: xui_core::render::RenderNodeId,
        descriptor: LayerDescriptor,
    ) -> (
        xui_core::render::RenderNodeId,
        xui_core::render::RenderNodeId,
    ) {
