...
use xui_core::render::render_graph::ImageResource;
use xui_core::render::{BuiltFrame, BuiltLayerInstance};
...
use super::{
    ...
    image::{
        draw_image_logical, draw_raster_image, image_bytes, make_image, CachedSourceImage,
        RasterImage,
    },
    paint::{
