...
//         let source = xui_core::render::RenderNodeId::default();
//         let clip_chains = clip
//             .map(|rect| {
//                 vec![xui_core::render::BuiltClipChain {
//                     source,
//                     parent: None,
...
//             .is_some();
//         root_items.push(BuiltItem::Layer(xui_core::render::BuiltLayerInstanceId(0)));
...
//         let mut ids = xui_core::render::RenderScene::new();
...
//         frame.layers[1].cache_id = Some(xui_core::render::LayerCacheId::Scene(child_source));
//         frame.live_layer_caches = (policy != CachePolicy::None)
//             .then_some(xui_core::render::LayerCacheId::Scene(child_source))
//             .into_iter()
//             .collect();
...
//                         BuiltItem::Layer(xui_core::render::BuiltLayerInstanceId(0)),
//                     ],
//                     BackdropIsolation::Isolate,
//                 ),
//                 built_layer(
//                     vec![BuiltItem::Layer(xui_core::render::BuiltLayerInstanceId(1))],
//                     isolation,
//                 ),
...
//                         item_count: 0,
//                     },
//                     placement: Some(xui_core::render::BuiltLayerInstanceId(0)),
//                 },
//             ],
//             clip_chains: Vec::new(),
//             live_layer_caches: Vec::new(),
